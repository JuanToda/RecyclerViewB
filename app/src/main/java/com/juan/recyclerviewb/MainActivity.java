...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _txtMahasiswaCount =
                findViewById(R.id.txtMahasiswaCount);
    ...
    private void loadRecyclerView() {
        ...
        String url =
                "https://stmikpontianak.cloud/011100862/tampilMahasiswa.php";
                    ...
                    public void onSuccess(
                        ...
                        mahasiswaModelList =
                                g.fromJson(
                                        ...
                                        new TypeToken<List<MahasiswaModel>>() {
                                        }.getType()
                                );
