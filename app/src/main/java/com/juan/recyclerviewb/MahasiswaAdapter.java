package com.juan.recyclerviewb;
...
public class MahasiswaAdapter
        extends RecyclerView.Adapter<MahasiswaViewHolder> {
    ...
    public void filter(
            List<MahasiswaModel> filteredList) {
    ...
    public void onBindViewHolder(
        ...
        MahasiswaModel mm =
                _mahasiswaModelList.get(position);

        holder._jkImageView.setImageResource(
                R.drawable.boy);

        if (mm.getJenisKelamin()
                .toLowerCase()
                .equals("perempuan")) {
    ...
    public int getItemCount() {
        ...
        int count =
                (_mahasiswaModelList != null)
                        ? _mahasiswaModelList.size()
                        : 0;
